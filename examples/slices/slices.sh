...
# they are rendered similarly by `println`.
$ v run slices.v
emp: [  ]
set: [a b c]
get: c
...
# by the V team for more details on the design and
# implementation of slices in V.

# Now that we've seen arrays and slices we'll look at
# V's other key builtin data structure: maps.
